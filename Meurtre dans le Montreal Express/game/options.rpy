...
define config.name = _("Meurtre dans le Montreal Express")
...
define build.name = "MeurtredansleMontrealExpress"
...
define config.save_directory = "MeurtredansleMontrealExpress-1746307156"
